...
<h2 style="font-weight: 600; color:black; margin-bottom: 40px;">Сериалы комедии</h2>
<?php
  ...
  $query = mysqli_query($connection, "SELECT * FROM serials WHERE category = 'Комедия' ORDER BY id DESC ");
