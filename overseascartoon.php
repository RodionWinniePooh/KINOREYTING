...
<h2 style="font-weight: 600; color:black; margin-bottom: 40px;">Мультфильмы зарубежные</h2>
...
<?php
  ...
  $query = mysqli_query($connection, "SELECT *FROM cartoons WHERE category = 'Зарубежные' ORDER BY id DESC ");
