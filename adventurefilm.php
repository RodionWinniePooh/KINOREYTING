...
<h2 style="font-weight: 600; color:black; margin-bottom: 40px;">Фильмы боевики</h2>
<?php
  ...
  $query = mysqli_query($connection, "SELECT * FROM film  WHERE category = 'Боевик' ORDER BY id DESC ");
