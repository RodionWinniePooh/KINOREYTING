...
<h2 style="font-weight: 600; color:black; margin-bottom: 40px;">Мультфильмы приключения</h2>
...
<?php
  ...
  $query = mysqli_query($connection, "SELECT *FROM cartoons WHERE category = 'Приключения' ORDER BY id DESC ");
